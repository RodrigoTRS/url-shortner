...
function redirectToRequestedUrl(req, res) {
  return __async(this, null, function* () {
    ...
    import_mongoose3.default.connect(`mongodb+srv://${env.MONGO_USER}:${env.MONGO_PASSWORD}@urlshortner.yqm8lst.mongodb.net/urls?retryWrites=true&w=majority&appName=urlshortner`);
